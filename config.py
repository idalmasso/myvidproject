...
class Config(object):
    ...
    MONGO_PORT = 27017
    MONGO_DBNAME = os.environ.get('MONGO_DBNAME') or 'video_app_db'
    SECRET_KEY = os.environ.get('SECRET_KEY') or 'secret-key-that_cannot-be-guessed'
    VIDEO_PER_PAGE = os.environ.get('VIDEO_PER_PAGE') or 20
    FILMS_FOLDER = os.environ.get('FILMS_FOLDER') or '/media/ivano/74868385-ab6b-4bae-a2b1-f2c9932c5fe3/ivano/Videos'
